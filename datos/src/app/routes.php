<?php
    // Define el espacio de nombres y las dependencias necesarias para los controladores y Slim
    ...
    $app->group('/api',function(RouteCollectorProxy $api){
        ...
        $api->group('/administrador',function(RouteCollectorProxy $endpoint){
         // Obtener artefactos o uno por ID
            $endpoint->get('/{id}', Administrador::class . ':buscar'); // Buscar administrador por identificacion
        ...
        $api->group('/visita',function(RouteCollectorProxy $endpoint){
         // Obtener artefactos o uno por ID
            ...
            $endpoint->get('/filtrar', Visita::class . ':filtrarNuevo'); 
        ...
        $api->group('/user', function (RouteCollectorProxy $endpoint) {
            $endpoint->patch('/autenticar', Autenticar::class . ':autenticarEndpoint');
            });
